...
## [#](https://oddfar.github.io/notes/pages/ee71b9/#优先级队列)优先级队列
...
![RabbitMQ-00000076](RabbitMQ-幂等性、优先级、惰性(9)/RabbitMQ-00000076.png)
...
![image-20210629163922085](RabbitMQ-幂等性、优先级、惰性(9)/image-20210629163922085.png)

## [#](https://oddfar.github.io/notes/pages/ee71b9/#惰性队列)惰性队列
...
![RabbitMQ-00000077](RabbitMQ-幂等性、优先级、惰性(9)/RabbitMQ-00000077.png)
