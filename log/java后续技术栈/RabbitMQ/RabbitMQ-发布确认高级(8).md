...
## [#](https://oddfar.github.io/notes/pages/c94906/#发布确认-springboot-版本)发布确认 springboot 版本

确认机制方案：

![RabbitMQ-00000068](RabbitMQ-发布确认高级(8)/RabbitMQ-00000068.png)

代码架构图：

![RabbitMQ-00000069](RabbitMQ-发布确认高级(8)/RabbitMQ-00000069.png)
...
访问： [http://localhost:8080/confirm/sendMessage/你好(opens new window)](http://localhost:8080/confirm/sendMessage/你好)

结果分析：

![image-20210629135636990](RabbitMQ-发布确认高级(8)/image-20210629135636990.png)

可以看到，发送了两条消息，第一条消息的 RoutingKey 为 "key1"，第二条消息的 RoutingKey 为 "key2"，两条消息都成功被交换机接收，也收到了交换机的确认回调，但消费者只收到了一条消息，因为第二条消息的 RoutingKey 与队列的 BindingKey 不一致，也没有其它队列能接收这个消息，所有第二条消息被直接丢弃了。

丢弃的消息交换机是不知道的，需要解决告诉生产者消息传送失败

## [#](https://oddfar.github.io/notes/pages/c94906/#回退消息)回退消息
...
![image-20210629143756078](RabbitMQ-发布确认高级(8)/image-20210629143756078.png)

## [#](https://oddfar.github.io/notes/pages/c94906/#备份交换机)备份交换机
...
![RabbitMQ-00000072](RabbitMQ-发布确认高级(8)/RabbitMQ-00000072.png)
...
![RabbitMQ-00000073](RabbitMQ-发布确认高级(8)/RabbitMQ-00000073.png)

- 访问： [http://localhost:8080/confirm/sendMessage/你好(opens new window)](http://localhost:8080/confirm/sendMessage/你好)

![image-20210629152752935](RabbitMQ-发布确认高级(8)/image-20210629152752935.png)
